    ...
    <div class="panel-body">
      {!! Form::open([ 'route' => 'bombero.store', 'class' => 'form-horizontal', 'method' => 'POST']) !!}
        ...
        <div class="form-group {{ $errors->has('cuartel') ? ' has-error' : '' }}">
          ...
          <div class="col-md-6">
          {!! Form::text('cuartel', null, ['class' => 'form-control']) !!}
        ...
        <div class="form-group {{ $errors->has('jerarquia') ? ' has-error' : '' }}">
          ...
          <div class="col-md-6">
          {{Form::select('jerarquia', config('selects.jerarquia'),6, ['class' => 'form-control'])}}
        ...
        <div class="form-group {{ $errors->has('fecha_nacimiento') ? ' has-error' : '' }}">
          ...
          <div class="col-md-6">
          {!! Form::text('fecha_nacimiento', null, ['class' => 'form-control', 'placeholder' => 'Día/Mes/Año']) !!}
