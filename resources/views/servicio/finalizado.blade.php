...
<article class="col-sm-12">
  ...
  {!! Form::open([ 'route' => 'servicio.store', 'class' => 'form-horizontal', 'method' => 'POST']) !!}
    ...
    <div class="form-group {{ $errors->has('autor_llamada') ? ' has-error' : '' }}">
      {!! Form::label('autor_llamada', 'Autor llamada',['class' => 'col-sm-4 control-label']) !!}
      <div class="col-sm-6">
          {!! Form::text('autor_llamada', null, ['class' => 'form-control']) !!}
    ...
    <div class="form-group">
        ...
        <div class="{{ $errors->has('vehiculo') ? ' has-error' : '' }}">
          ...
          <div class="col-sm-1">
            {{Form::select('Vehiculos', $vehiculos,null,['class' => 'selectMultiple', 'id'=>'listavehiculos'])}}
    ...
    <div class="form-group">
      <div class="{{ $errors->has('ilesos') ? ' has-error' : '' }}">
        {!! Form::label('ilesos', 'Ilesos',['class' => 'col-sm-2 col-sm-offset-2 control-label']) !!}
        <div class="col-md-1">
    ...
    <div class="form-group">
      <div class="{{ $errors->has('muertos') ? ' has-error' : '' }}">
        {!! Form::label('muertos', 'Muertos',['class' => 'col-sm-2 col-sm-offset-2 control-label']) !!}
        <div class="col-sm-1">
    ...
    <div class="form-group {{ $errors->has('cuartel_colaborador') ? ' has-error' : '' }}">
      {!! Form::label('cuartel_colaborador', 'Cuartel colaborador',['class' => 'col-sm-4 control-label']) !!}
      <div class="col-sm-6">
          {!! Form::text('cuartel_colaborador', null, ['class' => 'form-control']) !!}
    ...
    <div class="form-group">
      <div class="{{ $errors->has('jefe_servicio') ? ' has-error' : '' }}">
        {!! Form::label('jefe_servicio', 'Jefe Servicio',['class' => 'col-sm-3 control-label']) !!}
        <div class="col-sm-2">
          {{Form::select('jefe_servicio', $bomberos,null,['class' => 'selectMultiple'])}}
      ...
      <div class="{{ $errors->has('oficial') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-2">
          {{Form::select('oficial', $bomberos,null,['class' => 'selectMultiple'])}}
      ...
      <div class="{{ $errors->has('jefe_de_cuerpo') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-2">
          {{Form::select('jefe_de_cuerpo', $bomberos,null,['class' => 'selectMultiple'])}}
