...
class ServiceTest extends TestCase
{
  ...
  public function testBomberos()
  {
    ...
    $this->assertEquals($service->bomberos()->first()->servicio_id,$service->id);
    $this->assertEquals($service->bomberos()->count(), 1);
  }
  ...
  public function testScopeFechaAlarmaPeriodo()
  {
      ...
      $servicesMonthYear = Servicio::FechaAlarmaPeriodo('10', '2012', '01', '2014');
