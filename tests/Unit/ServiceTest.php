...
class ServiceTest extends TestCase
{
    ...
    public function testScopeFechaAlarma()
    {
      ...
      {
          $horaAlarma = new DateTime("2015-10-01 00:00:00", new DateTimeZone("America/New_York"));
          $horaAlarma2 = new DateTime("2013-11-01 00:00:00", new DateTimeZone("America/New_York"));
          $service = factory(Servicio::class)->create(['hora_alarma'=>$horaAlarma->format("Y-m-d H:i:s")]);
          ...
          $servicesMonthYear = Servicio::FechaAlarmaPeriodo('10', '2013', '11', '2014');
          $servicesMonthYear2 = Servicio::FechaAlarmaPeriodo('01', '2015', '01', '2016');
          $this->assertEquals($servicesMonthYear->count(),0);
